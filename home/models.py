...
class Order(models.Model):
    ...
    order_number = models.CharField(verbose_name="Order Number", max_length=20, unique=True, blank=False)
    file_upload = models.FileField(verbose_name="File Upload", upload_to="order_files/", blank=True, null=True)
